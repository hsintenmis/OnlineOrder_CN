 ...
 * 取得實際的 SD card 資料
 */
public class RealSDCardData {
	private ArrayList<String> mMounts = new ArrayList<String>();
	private ArrayList<String> mVold = new ArrayList<String>();

	/** Linux fstab 的標籤名稱 ex. external sd card */
	...
	private void readMountsFile() {
		 ...
		 * /dev/block/vold/179:1 /mnt/sdcard vfat rw,dirsync,nosuid,nodev,noexec
		 * ,relatime,uid=1000,gid=1015,fmask=0602 ,dmask=0602,allow_utime=0020
		 * ,codepage=cp437,iocharset=iso8859-1,shortname
